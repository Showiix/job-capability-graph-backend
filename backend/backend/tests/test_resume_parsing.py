...
def test_extracts_docx_textbox_paragraphs_from_xml() -> None:
    ...
    <w:document xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>
      <w:body>
        ...
        <w:txbxContent>
          <w:p>
            <w:r><w:t>前端开发、测试</w:t></w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Python / Vue / Git</w:t></w:r>
          </w:p>
        </w:txbxContent>
      </w:body>
    </w:document>
    ...
    assert _extract_docx_xml_paragraphs(
        xml,
        ".//w:txbxContent//w:p",
    ) == "前端开发、测试\nPython / Vue / Git"
